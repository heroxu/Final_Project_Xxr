...
import com.niupai_xxr_lqtj.App;
...
import com.niupai_xxr_lqtj.bean.IndexImgList;
import com.niupai_xxr_lqtj.myui.adapter.GoodListAdapter;
import com.niupai_xxr_lqtj.myui.view.Kanner;
import com.niupai_xxr_lqtj.myui.view.RecyclerViewBaseOnPullToRefresh;
import com.niupai_xxr_lqtj.network.manager.MyRetrofitManager;
import com.niupai_xxr_lqtj.utils.general.L;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case  R.id.buy_txt_popularity:
                this.id = HOT20;
                buy_txt_popularity.setTextColor(getResources().getColor(R.color.bg_red));
            ...
            case  R.id.buy_txt_newest:
                ...
                buy_txt_newest.setTextColor(getResources().getColor(R.color.bg_red));
                buy_txt_progress.setTextColor(getResources().getColor(R.color.txt_normal_title));
                buy_txt_all_person.setTextColor(getResources().getColor(R.color.txt_normal_title));
            ...
            case  R.id.buy_txt_progress:
                ...
                buy_txt_popularity.setTextColor(getResources().getColor(R.color.txt_normal_title));
                buy_txt_newest.setTextColor(getResources().getColor(R.color.txt_normal_title));
                buy_txt_progress.setTextColor(getResources().getColor(R.color.bg_red));
                buy_txt_all_person.setTextColor(getResources().getColor(R.color.txt_normal_title));
            ...
            case  R.id.buy_rl_all_person:
                ...
                buy_txt_newest.setTextColor(getResources().getColor(R.color.txt_normal_title));
                buy_txt_progress.setTextColor(getResources().getColor(R.color.txt_normal_title));
                buy_txt_all_person.setTextColor(getResources().getColor(R.color.bg_red));
